...
- On the [Deploy page](/zh-tw/usage/deploy/modify-deployment.md), mark some or all products/languages for uninstallation, then click Start Deploy to confirm the uninstallation.

::: warning Note

If you are unable to uninstall Office through normal means, you can [force remove Office](/zh-tw/usage/toolbox/office.md) on the Toolbox page. Force removing Office will clean both activation information and Office application settings, so you do not need to perform the following operations unless you skipped those items.
