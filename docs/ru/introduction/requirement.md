...
> Office Tool Plus не поддерживает macOS или Linux.
>
...
Вы можете скачать Office Tool Plus, который включает .NET Runtime и позволяет запускать программу без отдельной установки .NET Runtime.
